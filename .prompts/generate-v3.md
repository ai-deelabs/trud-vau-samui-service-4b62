...
Brand:
Trud vau samui service is a car shuttle service on Samui. The preferred style uses bright colors with a clean aesthetic. The main colors are white, silver, and grey, which are the primary colors of their vans, with gradients for light and shadow. Accent colors include dark blue (navy/almost black) and light blue (cyan). The overall color scheme is clean, conveying trustworthiness (silver/dark blue) and a sense of sea tourism (light blue/dark blue).

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Stacked full-width bands alternating light/dark, van silhouette as negative-space graphic element bleeding between sections — humanist sans with wide letter-spacing on oversized display size, italic contrast on pull-quotes — pearl white (#F5F6F8) + platinum (#B8BFC7) + slate charcoal (#2E3A47) + electric aqua (#00C2D4) — open-road calm with a flash of coastal vivacity
