...
Horizontal scroll sections with oversized route numbers as typographic landmarks, sticky sidebar navigation — geometric slab serif headlines contrasting with monospace data labels — cool white (#FAFBFC) + steel grey (#8A9199) + deep ink (#111827) + muted seafoam (#A8D5DC) — systematic, cartographic, confident infrastructure
